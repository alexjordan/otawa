...
/* externals */
extern arch_plugin_t *default_plugin_arch;
extern sys_plugin_t *default_plugin_sys;
 ...
 */
void gel_load_plugins(gel_platform_t *f, const char *plugpath) {
	char *buf = NULL;
	...
	f->arch = default_plugin_arch;
	f->sys = default_plugin_sys;
